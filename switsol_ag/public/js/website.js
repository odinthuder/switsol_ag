...
$(document).ready(function() {
	...
	if(getCookie("system_user")==="yes" && logged_in) {
		$("#website-post-login .dropdown-menu li:last-child").remove();
		$("#website-post-login .dropdown-menu").append('<li><a href="/desk">Zum Arbeitsplatz</a></li>');
		$(".navbar-header .dropdown:not(.dropdown-submenu) > .dropdown-menu")
			.append('<li><a href="/desk">Zum Arbeitsplatz</a></li>');
	}
